...
#    command => "[ -f ${inst_dir}/${pkg_tomcat}/lib/ecj*.jar ] && rm -f ${inst_dir}/${pkg_tomcat}/lib/ecj*.jar; cp -rf ${src_dir}/apache-tomcat-${tomcat_release}/* ${inst_dir}/${pkg_tomcat}",    
    command => "for f in ${inst_dir}/${pkg_tomcat}/lib/ecj*.jar; do [ -e \"\$f\" ] && rm -f ${inst_dir}/${pkg_tomcat}/lib/ecj*.jar || echo \"files do not exist\"; break; done; cp -rf ${src_dir}/apache-tomcat-${tomcat_release}/* ${inst_dir}/${pkg_tomcat}",    
